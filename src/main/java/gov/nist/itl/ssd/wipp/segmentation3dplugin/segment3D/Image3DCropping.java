...
public class Image3DCropping {
	...
	public int[] removeMeaninglessFrames16bits(ImagePlus img3D, int threshold) {
		...
		LOG.info("Finding useless frames at the beginning of the stack...");
		...
		LOG.info("Finding useless frames at the end of the stack...");
		...
		LOG.info("Removing frames and computing statistics about BKG...");
